...
\begin{center}
\includegraphics[scale=0.5]{F100-PW-220-Military_Jet_Acquisition_by_RAND_Project_Air_Force.png}
\end{center}
\end{figure}
...
\begin{center}
\includegraphics[scale=0.4]{Military_Turbofan_Schematic_Cantwell.png}
\end{center}
\end{figure}
