function [varargout] = exampleWrapper(x,knots,coefs,fidelity,output)
...
elseif( strcmp(fidelity,'med') )
    ...
    % 1) Determine where this optimization code is running
    homedir = pwd;
    % 2) Create a new subdirectory to run SU2 calculations in & move there
    ...
    % 4) Remove files generated by SU2
    files = strsplit(ls);
