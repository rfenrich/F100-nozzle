function [varargout] = nozzleGeometry(x,Dinlet,nozzleLength,xThroat,ARatio1,ARatio2,shape,outputResult)
...
areaRatio_inlet_to_throat = ARatio1;
areaRatio_outlet_to_throat = ARatio2;
